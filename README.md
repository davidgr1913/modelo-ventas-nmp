...
│                         ventasnmp and configuration for tools like black
│
...
│
└── ventasnmp   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes ventasnmp a Python module
    │
